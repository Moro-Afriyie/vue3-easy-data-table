...
import { useSlots, computed, toRefs, ref, watch, provide, onMounted, PropType } from 'vue';
...
const { serverOptionsComputed, updateServerOptionsPage, updateServerOptionsSort, updateServerOptionsRowsPerPage } =
	useServerOptions(serverOptions, multiSort, emits);

const { clientSortOptions, headerColumns, headersForRender, updateSortField, isMultiSorting, getMultiSortNumber } =
	useHeaders(
		showIndexSymbol,
		checkboxColumnWidth,
		expandColumnWidth,
